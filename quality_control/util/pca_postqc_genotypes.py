...
def read_eigenvector(file):
	...
	eigenvec = eigenvec.rename(columns={"IID": "rfid"})
	return eigenvec

def read_metadata(file):
	metadata = pd.read_csv(file, delimiter=",", dtype=str, usecols=["rfid", "library_name", "project_name", "sex"])
	return metadata
...
if __name__=="__main__":
	...
	eigenvec_metadata = pd.merge(eigenvector, metadata, on=["rfid"], how="left")
	...
	pca_outliers = eigenvec_metadata[['rfid','library_name','project_name','sex','PC1','PC2','PC3','PC4']]
